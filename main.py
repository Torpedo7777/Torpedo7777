...
def on_up_pressed():
    if crab.is_hitting_tile(CollisionDirection.BOTTOM):
        crab.vy = -200
controller.up.on_event(ControllerButtonEvent.PRESSED, on_up_pressed)

def on_combos_attach_combo():
    animation.run_image_animation(crab,
        [img("""
                ...................cc...
                        ...............cccc63c..
                        ..............c633336c..
        ...
        100,
        True)
controller.combos.attach_combo("A + left", on_combos_attach_combo)
...
def on_a_pressed():
    ...
    def on_throttle():
        crab.vy = -200
    timer.throttle("action", 1500, on_throttle)
...
def on_combos_attach_combo2():
    animation.run_image_animation(crab,
        ...
        100,
        True)
controller.combos.attach_combo("up + A + right", on_combos_attach_combo2)
...
crab = sprites.create(img("""
    ...
    """),
    SpriteKind.player)
controller.move_sprite(crab, 100, 0)
tiles.set_current_tilemap(tilemap("""
    level1
"""))
scene.camera_follow_sprite(crab)
crab.ay = 500
...
statusbar.set_label(game.ask_for_string("Player 1", 3))
...
def on_update_interval():
    ...
    coin2 = sprites.create(img("""
        ...
        """),
        SpriteKind.coin)
    tiles.place_on_random_tile(coin2, assets.tile("""
        myTile9
    """))
